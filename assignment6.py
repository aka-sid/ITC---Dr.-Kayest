...
student_data(student_id="21102096")
student_data(student_id="21102096",student_name="Siddharth Kulshrestha")
student_data(student_id="21102096",student_name="Siddharth Kulshrestha",student_class="1st Year")
print()
